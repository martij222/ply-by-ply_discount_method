function [ local_stress, local_strain ] = computelocalstressstrain( global_strain, Qbar, theta, E11, E22, G12 )
%computelocalstressstrain Compute local stresses and strains at the top and bottom surfaces
