function [ tsai_wu_H_SR ] = tsai_wu_H_FPF( local_stress, sig1_T_ult, sig1_C_ult, sig2_T_ult, sig2_C_ult, tau12_ult )
%tsai_wu_H_FPF Compute strength ratio using Tsai-Wu failure theory (Hoffman criterion)
