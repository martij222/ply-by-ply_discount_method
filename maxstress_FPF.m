function [ maxstress_SR ] = maxstress_FPF( local_stress, sig1_T_ult, sig1_C_ult, sig2_T_ult, sig2_C_ult, tau12_ult )
%maxstress_FPF Compute strength ratio using maximum stress failure theory
