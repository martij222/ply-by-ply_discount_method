function [ mod_tsai_hill_SR ] = tsai_hill_FPF( local_stress, sig1_T_ult, sig1_C_ult, sig2_T_ult, sig2_C_ult, tau12_ult )
%tsai_hill_FPF Compute strength ratio using modified Tsai-Hill failure theory
